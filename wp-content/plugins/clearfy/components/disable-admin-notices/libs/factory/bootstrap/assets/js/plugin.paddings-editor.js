( function( $ ){
    ...
    $.fn.factoryBootstrap482_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap482_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-482 .factory-paddings-editor").factoryBootstrap482_paddingsEditor();
    });
