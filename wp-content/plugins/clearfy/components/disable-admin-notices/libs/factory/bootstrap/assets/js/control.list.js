( function( $ ){
    ...
    $.fn.factoryBootstrap482_listControl = function (option) {
    ...
    $.fn.factoryBootstrap482_listControl.Constructor = list;

    $(function(){
        $(".factory-bootstrap-482 .factory-list").factoryBootstrap482_listControl();
    });
