( function( $ ){
    ...
    $.fn.factoryBootstrap482_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap482_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-482 .factory-gradient").factoryBootstrap482_gradientControl();
    });
